...
import Refactorjs from '../lib/refactorjs';
  ...
  describe('when the refactorjs:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        let refactorjsElement = workspaceElement.querySelector('.refactorjs');
        expect(refactorjsElement).toExist();

        let refactorjsPanel = atom.workspace.panelForItem(refactorjsElement);
